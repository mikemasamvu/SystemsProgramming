...
void boot(void) {
    ...
    7d8d:	81 3c 25 00 00 01 00 	cmpl   $0x464c457f,0x10000
    7d94:	7f 45 4c 46 
    7d98:	74 02                	je     7d9c <boot+0x2b>
    7d9a:	eb fe                	jmp    7d9a <boot+0x29>
    elf_program* eph = ph + ELFHDR->e_phnum;
    7d9c:	0f b7 2c 25 38 00 01 	movzwl 0x10038,%ebp
    7da3:	00 
    elf_program* ph = (elf_program*) ((uint8_t*) ELFHDR + ELFHDR->e_phoff);
    7da4:	48 8b 04 25 20 00 01 	mov    0x10020,%rax
    7dab:	00 
    elf_program* eph = ph + ELFHDR->e_phnum;
    7dac:	48 6b ed 38          	imul   $0x38,%rbp,%rbp
    elf_program* ph = (elf_program*) ((uint8_t*) ELFHDR + ELFHDR->e_phoff);
    7db0:	48 8d 98 00 00 01 00 	lea    0x10000(%rax),%rbx
    elf_program* eph = ph + ELFHDR->e_phnum;
    7db7:	48 01 dd             	add    %rbx,%rbp
    for (; ph < eph; ++ph) {
    7dba:	48 39 eb             	cmp    %rbp,%rbx
    7dbd:	73 21                	jae    7de0 <boot+0x6f>
        boot_readseg(ph->p_va, ph->p_offset / SECTORSIZE + 1,
    7dbf:	48 8b 73 08          	mov    0x8(%rbx),%rsi
    7dc3:	48 8b 4b 28          	mov    0x28(%rbx),%rcx
    for (; ph < eph; ++ph) {
    7dc7:	48 83 c3 38          	add    $0x38,%rbx
        boot_readseg(ph->p_va, ph->p_offset / SECTORSIZE + 1,
    7dcb:	48 8b 53 e8          	mov    -0x18(%rbx),%rdx
    7dcf:	48 8b 7b d8          	mov    -0x28(%rbx),%rdi
    7dd3:	48 c1 ee 09          	shr    $0x9,%rsi
    7dd7:	ff c6                	inc    %esi
    7dd9:	e8 c8 fe ff ff       	call   7ca6 <boot_readseg>
    for (; ph < eph; ++ph) {
    7dde:	eb da                	jmp    7dba <boot+0x49>
    kernel_entry();
    7de0:	ff 14 25 18 00 01 00 	call   *0x10018
